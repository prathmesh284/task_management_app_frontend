/**
 * EmpTaskCommentsDrawer Component
 * -------------------------------
 * This component displays a side drawer that shows
 * all comments related to a selected task.
 * It also allows employees to add new comments.
 */
...
const EmpTaskCommentsDrawer = ({ task, onClose }) => {
  ...
  /**
   * Fetch comments whenever a new task is selected.
   */
  useEffect(() => {
    if (task) {
   ...
   * Performs basic validation and updates UI after success.
   */
  ...
  // Do not render drawer if no task is selected
  if (!task) return null;
